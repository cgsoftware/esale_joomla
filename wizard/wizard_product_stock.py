        ...
        for osc_product in website.product_ids:
            if osc_product.esale_joomla_id:
                webproduct={
                    ...
                    'quantity':osc_product.product_id.qty_available, 
                    'shop':website.shop_id.id, 
                    'ID':osc_product.product_id.id, 
                    'Code':osc_product.product_id.code, 
                    'Article':osc_product.product_id.article, 
                }
